...
const About = () => {
  return (
   ...
   <h1 className="lg:text-4xl text-xl italic uppercase font-black mt-7">The team</h1>
   ...
   The Core Team is comprised of Maria and Aleksey. They have been working together for many years creating 3d characters and animation for tv commercials and various other mediums. 
    ...
    <p className="text-base leading-8 py-4">Another User have been at this for like 16 years. Between the 2 of us we have a tonne of experience. We’ve also been running a successful online shop selling 3d character assets for people to use in their own projects.</p>
    <p className="text-base leading-8 py-4">
