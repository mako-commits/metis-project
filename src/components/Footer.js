...
const Footer = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap md:text-left text-center order-first">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Learn</h2>
        <nav className="list-none mb-10">
          <li>
          <Link to="#" className=" text-gray-600 hover:text-gray-800">
          Creators
      ...
      <div className="lg:w-2/4 md:w-1/2 w-full px-4">
        ...
        <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          ...
          <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Sign Up</button>
        </div>
  ...
  <div className="bg-gray-100">
    ...
    <span className="ml-3 text-xl">Metis Hack</span>
            </Link>
      
      <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2022 Metis Hack
